...
export default function Projects({ projects }: Props) {
  ...
  return (
    <>
      {isMobile ?
        <div className='flex flex-col relative overflow-hidden h-screen  md:flex-row max-w-full justify-evenly mx-auto items-center z-0 '>
          <h3 className='absolute ml-5 top-24 uppercase tracking-[20px] text-gray-500 text-2xl text-center'>Projects</h3>
                ...
                <div className='space-y-5 px-0 md-px-40 max-w-6xl'>
                  ...
                  {!project.isMobile ?
                    ...
                    <div className='flex flex-row justify-center'>
                      <a href={project.linkToBuildApple} target='_blank' className='italic text-center text-xs md:text-sm underline decoration-[#8257e5]/50 hover:cursor-pointer hover:animate-pulse'>
                        <AppStoreLogo className='text-[#ffffff] h-7 w-7 animate-pulse' />
                      </a>
                      <a href={project.linkToBuildPlayStore} target='_blank' className='italic text-center text-xs md:text-sm underline decoration-[#8257e5]/50 hover:cursor-pointer hover:animate-pulse'>
