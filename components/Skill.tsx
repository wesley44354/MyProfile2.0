...
export default function Skill({ skill, directionLeft }: Props) {
  return (
    ...
    >
      ...
      />
      <div className='absolute opacity-0 group-hover:opacity-80 transition duration-300 ease-in-out group-hover:[#40335e] w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 xl:h-32 xl:w-32 rounded-full'>
